...
/****** Object:  StoredProcedure [dbo].[spSelectUserByCredentials]    Script Date: 11/8/2020 12:14:42 PM ******/
DROP PROCEDURE [dbo].[spSelectUserByCredentials]
GO

/****** Object:  StoredProcedure [dbo].[spSelectProductByID]    Script Date: 11/8/2020 12:14:42 PM ******/
DROP PROCEDURE [dbo].[spSelectProductByID]
GO

/****** Object:  StoredProcedure [dbo].[spSelectAllStates]    Script Date: 11/8/2020 12:14:42 PM ******/
DROP PROCEDURE [dbo].[spSelectAllStates]
GO

/****** Object:  StoredProcedure [dbo].[spSelectAllProducts]    Script Date: 11/8/2020 12:14:42 PM ******/
DROP PROCEDURE [dbo].[spSelectAllProducts]
GO

/****** Object:  StoredProcedure [dbo].[spInsertUser]    Script Date: 11/8/2020 12:14:42 PM ******/
DROP PROCEDURE [dbo].[spInsertUser]
GO

/****** Object:  StoredProcedure [dbo].[spInsertMyOrder]    Script Date: 11/8/2020 12:14:42 PM ******/
...
/****** Object:  StoredProcedure [dbo].[spInsertUser]    Script Date: 11/8/2020 12:14:43 PM ******/
SET ANSI_NULLS ON
GO
...
(FirstName, LastName, Address1, Address2, City, StateID, Zipcode, Username, UserPassword, RecoveryEmail)
values
(@FirstName, @LastName, @Address1, @Address2, @City, @StateID, @Zipcode, @Username, @UserPassword, @RecovereyEmail)
END
GO

/****** Object:  StoredProcedure [dbo].[spSelectAllProducts]    Script Date: 11/8/2020 12:14:43 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[spSelectAllStates]    Script Date: 11/8/2020 12:14:43 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[spSelectProductByID]    Script Date: 11/8/2020 12:14:44 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[spSelectUserByCredentials]    Script Date: 11/8/2020 12:14:44 PM ******/
SET ANSI_NULLS ON
GO
